...
<head>
    ...
    <title>Akilliphone Sipariş Bilgisi</title> <!--[if (mso 16)]>
    ...
    <style type="text/css">#outlook a {
        ...
        td .es-button-border:hover a.es-button-1696530823214 {
            background: #0f9dc1 !important;
        }

        td .es-button-border-1696530823227:hover {
            background: #0f9dc1 !important;
        }

        td .es-button-border:hover a.es-button-1696530948114 {
            background: #0f9dc1 !important;
        }

        td .es-button-border-1696530948125:hover {
            background: #0f9dc1 !important;
        }
...
<div dir="ltr" class="es-wrapper-color" lang="tr" style="background-color:#F6F6F6"> <!--[if gte mso 9]>
                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td class="es-m-p20b" align="left"
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                           ...
                                                           role="presentation">
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left" style="padding:0;Margin:0"><h4
                                                                    style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;color:#16c0ec">
                                                                    Bizimle iletişime geçiniz:</h4></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="left"
                                                                style="padding:0;Margin:0;padding-top:10px;padding-bottom:15px">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                    Siparişiniz ile ilgili tüm konular için bizimle
                                                                    iletişime geçebilirsiniz.</p></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                                ...
                                                                <table class="es-table-not-adapt" cellspacing="0"
                                                                    ...
                                                                    <tr style="border-collapse:collapse">
                                                                        <td valign="top" align="left"
                                                                            style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px;padding-right:10px;font-size:0">
                                                                            <img src="https://ebfcecw.stripocdn.email/content/guids/CABINET_45fbd8c6c971a605c8e5debe242aebf1/images/30981556869899567.png"
                                                                                 alt width="16"
                                                                                 style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                                 height="13"></td>
                                                                    ...
                                                                    <tr style="border-collapse:collapse">
                                                                        <td valign="top" align="left"
                                                                            style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px;padding-right:10px;font-size:0">
                                                                            <img src="https://ebfcecw.stripocdn.email/content/guids/CABINET_45fbd8c6c971a605c8e5debe242aebf1/images/58031556869792224.png"
                                                                                 alt width="16"
                                                                                 style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                                 height="16"></td>
                                                                        <td align="left" style="padding:0;Margin:0">
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center" style="padding:0;Margin:0;font-size:0px">
                                                                <img class="adapt-img"
                                                                     src="https://ebfcecw.stripocdn.email/content/guids/CABINET_a41872988c5b2892f342896e3cac68b8a0899310882c13f465f299c49f315335/images/screenshot_1_I8W.png"
                                                                     alt
                                                                     style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                     width="270" height="191"></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                    ...
                    <tr style="border-collapse:collapse">
                        <td align="center" style="padding:0;Margin:0">
                            <table class="es-footer-body"
                                ...
                                <tr style="border-collapse:collapse">
                                    <td style="Margin:0;padding-bottom:15px;padding-top:20px;padding-left:20px;padding-right:20px;background-color:#16c0ec"
                                        bgcolor="#16c0ec" align="left">
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                                ...
                                                                <table class="es-table-not-adapt es-social"
                                                                    ...
                                                                    <tr style="border-collapse:collapse">
                                                                        <td valign="top" align="center"
                                                                            ...
                                                                            <img title="Facebook"
                                                                                 src="https://ebfcecw.stripocdn.email/content/assets/img/social-icons/circle-white/facebook-circle-white.png"
                                                                        ...
                                                                        <td valign="top" align="center"
                                                                            style="padding:0;Margin:0;padding-right:15px">
                                                                            <img title="Twitter"
                                                                                 src="https://ebfcecw.stripocdn.email/content/assets/img/social-icons/circle-white/twitter-circle-white.png"
                                                                        ...
                                                                        <td valign="top" align="center"
                                                                            style="padding:0;Margin:0"><img
                                                                                title="Youtube"
                                                                                src="https://ebfcecw.stripocdn.email/content/assets/img/social-icons/circle-white/youtube-circle-white.png"
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center" style="padding:0;Margin:0"><p
                                                                    ...
                                                                    Tüm hakları Akıllıphone.com'a ait olup dağıtılması veya
                                                                    kopyalanması kesinlikle yasaktır.</p></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center"
                                                                style="padding:0;Margin:0;padding-bottom:10px;padding-top:15px;font-size:0">
                                                                <img src="https://ebfcecw.stripocdn.email/content/guids/CABINET_c6d6983b8f90c1ab10065255fbabfbaf/images/15841556884046468.png"
                                                                     alt
                                                                     style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                     width="140" height="17"></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center"
